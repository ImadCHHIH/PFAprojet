...
export default function CompanyPage() {
    ...
    const handleSave = async (company) => {
        try {
            ...
            console.error(error);
            alert(error.response?.data?.message || "Impossible d'enregistrer l'entreprise.");
        }
    };
                    ...
                    >
                        ...
                        >
                            <Box>
                                ...
                                >
                                    <StorefrontIcon sx={{ fontSize: "2rem", opacity: 0.9 }} />
                                    <Typography
                                        sx={{
                                ...
                                >
                                    Gérez vos entreprises de beauté et bien-être
                                </Typography>
                            </Box>

                            <Chip
                                icon={<BusinessCenterIcon />}
                                label={`${companies.length} entreprises`}
                                sx={{
