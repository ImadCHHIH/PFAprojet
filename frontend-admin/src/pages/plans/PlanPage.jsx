...
export default function PlanPage() {
    ...
    const blue = {
        ...
        textMuted: isDark ? "rgba(255,255,255,0.25)" : "rgba(30, 41, 59, 0.25)"
    };
                    ...
                    >
                        ...
                        >
                            <Box>
                                ...
                                >
                                    <SpaIcon sx={{ fontSize: "2rem", opacity: 0.9 }} />
                                    <Typography
                                        sx={{
                    ...
                    >
                        <Box>
                            ...
                            >
                                ...
                                {activePlans > 0 && ` · ${activePlans} actif${activePlans > 1 ? "s" : ""}`}
                            </Typography>
                        </Box>
